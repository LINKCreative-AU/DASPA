...
- **Affiliate IDs live only in `data/merchants.json`.** Products store `{merchant, merchantRef}`; links are built at render time with proper `rel="sponsored"`.
