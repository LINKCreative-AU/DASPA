...
| Application terms (~450+) | `dasp online application` 250 · `dasp application` 90 · `dasp form` 40 · `dasp application form (pdf)` 50 · `…login` 20 | **/dasp-online-application** — answer-first "it's online-only, two ways to apply"; honest ATO-option comparison; catches form/PDF/login long-tail in FAQs |
...
- **Deliberately noindexed:** `/claim`, `/verify`, `/confirmation` — transactional steps with
