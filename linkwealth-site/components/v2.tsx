...
// Wealth carries them with the register teal as the only accent.
...
type PillVariant = "solid" | "ghost" | "accent" | "onDark" | "ghostDark";
...
> = {
  ...
  accent: { wrap: "bg-wealth text-white", circleBg: "#ffffff", circleFg: "#1f9e84" },
...
export function EyebrowPill({
  ...
  children: ReactNode;
  tint?: boolean; // register light teal fill instead of the bordered pill
  onDark?: boolean;
}) {
  return (
    <span
