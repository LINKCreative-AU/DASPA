...
export function SendFailed({ dark = false }: { dark?: boolean }) {
  return (
    <p
      role="alert"
      className={
        dark
          ? "mt-4 rounded-lg border border-red-300/40 bg-red-950/40 px-4 py-3 text-sm text-red-200"
          : "mt-4 rounded-lg border border-red-300 bg-red-50 px-4 py-3 text-sm text-red-900"
      }
    >
