...
const data: LoanPageData = {
  ...
  intro:
    "Fortitude Valley based, Australia wide. One broker handles your whole loan: comparison across 35+ lenders, the negotiation, the paperwork, settlement, and the six-monthly repricing your bank hopes you'll forget.",
  bullets: [
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "We're based at Level 1, 57 Berwick Street, Fortitude Valley (parking on site, good coffee), and most of Brisbane's inner north can walk in. But lending is national: we settle loans across Queensland and Australia-wide, with everything handled by phone and email when that's easier.",
      ],
    },
  ],
  features: [
    ...
    { title: "No cost to you on home loans.", body: "The lender pays the broker on settlement; we disclose the commission. You pay nothing for the comparison." },
  ],
  faqs: [
    { q: "Is it worth using a mortgage broker in Brisbane?", a: "Brokers now write the majority of Australian home loans, for one reason: a broker compares dozens of lenders and negotiates with the leverage of taking your loan elsewhere. You get more competition for your loan at no cost. The lender pays the broker on settlement." },
    { q: "How do mortgage brokers get paid?", a: "For home loans, by the lender: an upfront commission and a small trailing commission, both disclosed to you in full. Brokers are also legally bound by a Best Interests Duty; a bank's staff can only sell that bank's products." },
...
export const metadata: Metadata = {
  ...
  description:
    "LINK Advance's Brisbane mortgage brokers compare 35+ lenders and stay on your loan for life, repricing included. 5.0 stars across 262 Google reviews. On home loans the lender pays us, not you.",
